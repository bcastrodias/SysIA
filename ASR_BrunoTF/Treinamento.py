...
from Configuracao import ModelConfigs


def download_and_unzip(url, extract_to="C:/Users/IA Funcional/Datasets", chunk_size=1024*1024):
...
dataset_path = os.path.join("model_path", "LJSpeech-1.1")
if not os.path.exists(dataset_path):
    download_and_unzip("https://data.keithito.com/data/speech/LJSpeech-1.1.tar.bz2", extract_to="C:/Users/IA Funcional/Datasets")

dataset_path = "C:/Users/IA Funcional/Datasets"
...
dataset = [[f"C:/Users/IA Funcional/Datasets/LJSpeech-1.1/wavs/{file}.wav", label.lower()] for file, label in metadata_df.values.tolist()]

# Herdar o objeto do ModelConfigs com as configurações do modelo
...
# Splitar o dataset (testando com 9 e 1)
train_data_provider, val_data_provider = data_provider.split(split = 0.9)

# Estrutura simploes do TF
model = train_model(
...
# Salvar os modelos splitados (treinamento e validação)
